...
document.getElementById('generate-qr-code').addEventListener('click', function() {
  console.log('Botão de gerar QR Code clicado.'); // Verificar se o evento de clique está sendo acionado
...
document.getElementById('card-payment').addEventListener('click', function() {
  console.log('Botão de pagamento com cartão de crédito clicado.'); // Verificar se o evento de clique está sendo acionado
